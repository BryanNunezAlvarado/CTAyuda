...
<body>
	...
	<div class="login-page">
		<div class="container">
			<h3 class="w3ls-title w3ls-title1">Recuperar Cuenta</h3>
			<div class="login-body">

				<form action="recuperar_contraseña.php" method="post">
					<input type="text" class="user" name="email_recuperar" placeholder="Email" required="">
					<input type="submit" value="Recuperar contraseña" name="boton_recuperar">
